...
}, '@VERSION@', { requires: ['view', 'intl', 'gallery-paginator-dev-preview-core'] });
...
}, '@VERSION@', { requires: ['base-build', 'gallery-paginator-dev-preview-core', 'gallery-paginator-dev-preview-simple-view'] });
