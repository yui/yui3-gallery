...
}, 'gallery-2012.08.01-13-16', {requires: ['base-build', 'widget', 'node', 'io', 'history', 'pjax', 'event-delegate', 'cache-base', 'selector-css3']});


}, 'gallery-2012.08.01-13-16' ,{requires:['base-build', 'widget', 'node', 'io', 'history', 'pjax', 'event-delegate', 'cache-base', 'selector-css3'], skinnable:false});
