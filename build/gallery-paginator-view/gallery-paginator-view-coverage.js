...
console.log('updatePageSelect fired after render ...');
    ...
    _inputChangePage: function(e) {
        _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "_inputChangePage", 1047);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1048);
var tar = e.target,
            val = +tar.get('value') || 1,
            model = this.get('model');
...
val = 1;
            _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1054);
tar.set('value',val);
        }
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1056);
model.set('page',val);
    },
    ...
    _clickChangePage: function(e) {
        _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "_clickChangePage", 1072);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1073);
var tar   = e.target,
            model = this.get('model');
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1075);
e.preventDefault();

        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1077);
if (e.target.hasClass(this._myClassName('disabled')) || e.currentTarget.hasClass(this._myClassName('disabled'))) {return;}

        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1079);
var page  = tar.getData('pglink') || e.currentTarget.getData('pglink'),
            npage = model.get('totalPages'),
            cpage = model.get('page'); //tar.get('text');

        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1083);
if ( cpage && cpage === page ) {return;}

        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1085);
switch(page) {
            case 'first':
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1087);
page = 1;
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1088);
break;
            case 'last':
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1090);
page = npage;
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1091);
break;
            case 'prev':
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1093);
page = (!cpage) ? 1 : (cpage === 1) ? npage : cpage - 1;
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1094);
break;
            case 'next':
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1096);
page = (!cpage) ? 1 : (cpage === npage ) ? 1 : cpage + 1;
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1097);
break;
            default:
                _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1099);
page = +page;

        }

        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1103);
model.set('page',page);
    },
    ...
    _selectChangeRowOptions: function(e){
        _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "_selectChangeRowOptions", 1115);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1116);
var tar = e.target,
...
if ( Y.Lang.isString(val) && val.toLowerCase() === 'all' ) {
            _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1120);
...
this.get('model').set('itemsPerPage',val);
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1123);
this.render();
    },
    ...
    resizePaginator: function() {
        _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "resizePaginator", 1136);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1137);
if ( this.get('paginatorResize') !== true || !this.get('dt') )  {return;}

        //TODO:  this is a total HACK, should figure a better way than later ...
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1140);
if ( !this._syncPaginatorSize() )
            {_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1141);
Y.later(100,this,function(){ _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "(anonymous 8)", 1141);
this._syncPaginatorSize(); } );}
    ...
    _syncPaginatorSize: function() {
        _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "_syncPaginatorSize", 1152);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1153);
var tblCont = this.get('dt').get('boundingBox').one('table');
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1154);
if ( !tblCont ) {return false;}

        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1156);
this.get('container').setStyle('width',tblCont.getComputedStyle('width'));
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1157);
this.fire('resize');
        _yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1158);
return true;
    }
    ...
    ATTRS:{
        ...
        paginatorTemplate:  {
            valueFn: function(){
                _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "valueFn", 1260);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1261);
return this.TMPL_PAGINATOR;
        ...
        pageLinkTemplate:   {
            valueFn: function(){
                _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "valueFn", 1282);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1283);
return this.TMPL_LINK;
        ...
        dt: {
            value:      null,
            validator:  function(v){ _yuitest_coverfunc("/build/gallery-paginator-view/gallery-paginator-view.js", "validator", 1429);
_yuitest_coverline("/build/gallery-paginator-view/gallery-paginator-view.js", 1429);
