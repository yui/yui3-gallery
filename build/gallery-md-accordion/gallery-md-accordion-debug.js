YUI.add('gallery-md-accordion', function(Y) {
...
}, '@VERSION@' ,{requires:['widget', 'widget-parent', 'widget-child', 'widget-stdmod', 'gallery-makenode'], optional:['resize-plugin', 'transition'], skinnable:true});
