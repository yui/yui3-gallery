...
this.initChildren();
    ...
    initChildren: function () {
        _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "initChildren", 83);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 84);
this._updateSlide();
    },
    ...
    _percentWidth: function (P) {
        _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "_percentWidth", 94);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 95);
var V = P || this.get('labelWidth');

        _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 97);
return Math.floor(V * this.get('boundingBox').get('offsetWidth') / 100);
    ...
    _showNeighbors: function (T) {
        _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "_showNeighbors", 107);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 108);
var scroll = this.get('scrollView');

        _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 110);
if (scroll) {
...
scroll.get('boundingBox').setStyles({
    ...
    _updateSlide: function () {
        _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "_updateSlide", 123);
...
var scroll = this.get('scrollView'),
        ...
        _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 129);
...
scroll.set('width', W);
            _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 135);
if (ttl) {
...
if (show) {
                _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 139);
this._showNeighbors(true);
    ...
    ATTRS: {
        ...
        selectedIndex: {
            ...
            lazyAdd: false,
            setter: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "setter", 163);
...
var tab = this.get('tabNode'),
                ...
                _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 170);
if (O && (old !== O)) {
...
old.removeClass('on');
                    ...
                    _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 175);
this.syncScroll();
                    _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 176);
return V * 1;
                }
                _yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 178);
return oldV;
            }
        },
        ...
        slideNode: {
            ...
            writeOnce: true,
            setter: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "setter", 202);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 203);
return this.get('contentBox').one(V).addClass(CLASSES.SLIDE);
        ...
        labelNode: {
            ...
            writeOnce: true,
            setter: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "setter", 217);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 218);
return this.get('slideNode').all(V);
        ...
        labelWidth: {
            ...
            validator: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "validator", 231);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 232);
return (V > 0) && (V <= 100);
            },
            setter: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "setter", 234);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 235);
return V * 1;
            }
        },
        ...
        showNeighbors: {
            ...
            setter: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "setter", 250);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 251);
...
return V;
        ...
        tabNode: {
            ...
            writeOnce: true,
            setter: function (V) {
                _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "setter", 266);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 267);
return this.get('contentBox').one(V).addClass(CLASSES.TAB);
    ...
    HTML_PARSER: {
        slideNode: function (srcNode) {
            _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "slideNode", 281);
...
return srcNode.getData('slide-node') || '> ul';
        ...
        labelNode: function (srcNode) {
            _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "labelNode", 284);
...
return srcNode.getData('label-node') || '> li';
        ...
        labelWidth: function (srcNode) {
            _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "labelWidth", 287);
...
return srcNode.getData('label-width') || 30;
        ...
        showNeighbors: function (srcNode) {
            _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "showNeighbors", 290);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 291);
return (srcNode.getData('show-neighbors') !== 'false');
        },
        tabNode: function (srcNode) {
            _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "tabNode", 293);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 294);
return srcNode.getData('tab-node') || '> div';
        },
        selectedIndex: function (srcNode) {
            _yuitest_coverfunc("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", "selectedIndex", 296);
_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 297);
return srcNode.getData('selected-index') || 0;
        }
    }
});

_yuitest_coverline("/build/gallery-bt-slidetab/gallery-bt-slidetab.js", 302);
