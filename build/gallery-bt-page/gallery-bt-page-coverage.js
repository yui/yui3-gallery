...
return instances;
    ...
    scrollTo: function (position, duration) {
        _yuitest_coverfunc("/build/gallery-bt-page/gallery-bt-page.js", "scrollTo", 145);
_yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 146);
var S = current ? current.topScroll() : null,
            Y;
        _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 148);
if (current) {
            _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 149);
if (position.getY) {
                _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 150);
Y = S.get('scrollY');
                _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 151);
S.scrollTo(0, 0, 0);
                _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 152);
position = position.getY() - S.get('boundingBox').getY();
                _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 153);
S.scrollTo(0, Y, 0);
            }
            _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 155);
S.scrollTo(0, position, duration);
        } else {
            _yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 157);
window.scrollTo(0, position.getY ? position.getY() : position);
     ...
     */
    getCurrent: function () {
        _yuitest_coverfunc("/build/gallery-bt-page/gallery-bt-page.js", "getCurrent", 168);
_yuitest_coverline("/build/gallery-bt-page/gallery-bt-page.js", 169);
return current;
    }
});
