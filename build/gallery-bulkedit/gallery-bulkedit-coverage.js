 ...
 */
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2606);
HTMLTableBulkEditor.inputFormatter = function(o)
{
	_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "inputFormatter", 2606);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2608);
 ...
 * @param o {Object} cell, key, value, field, column, record
 */
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2618);
HTMLTableBulkEditor.textareaFormatter = function(o)
{
	_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "textareaFormatter", 2618);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2620);
 ...
 * @param o {Object} cell, key, value, field, column, record
 */
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2630);
HTMLTableBulkEditor.selectFormatter = function(o)
{
	_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "selectFormatter", 2630);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2632);
 ...
 * @param o {Object} cell, key, value, field, column, record
 */
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2642);
HTMLTableBulkEditor.checkboxFormatter = function(o)
{
	_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "checkboxFormatter", 2642);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2644);
...
{
	_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "checkboxMultiselectFormatter", 2654);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2656);
...
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2694);
function moveFocus(e)
{
	_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "moveFocus", 2694);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2696);
e.halt();

	_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2698);
var info = this.getRecordAndFieldKey(e.target);
	_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2699);
if (!info)
	{
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2701);
return;
	}

	_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2704);
...
bd = bd.previous();
	...
	else {_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2709);
if (bd)
	{
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2711);
bd = bd.next();
	}}

	_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2714);
var id = bd && this.getRecordId(bd);
	_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2715);
if (id)
	{
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2717);
var field = this.getFieldElement(id, info.field_key);
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2718);
if (field)
		{
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2720);
try
			{
				_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2722);
field.focus();
				_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2723);
field.select();
			}
			catch (ex)
			{
...
Y.extend(HTMLTableBulkEditor, BulkEditor,
{
	...
	_renderContainer: function(
		/* element */	container)
	{
		_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "_renderContainer", 2741);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2744);
var table_class = Y.ClassNameManager.getClassName(HTMLTableBulkEditor.NAME);

		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2746);
if (!this.table ||
			container.get('firstChild').get('tagName').toLowerCase() != 'table' ||
			!container.get('firstChild').hasClass(table_class))
		{
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2750);
var s = Y.Lang.sub('<table class="{t}"><thead class="{hd}"><tr>',
			...
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2756);
var row_markup = '<th class="{cell} {prefix}{key}">{label}</th>';

			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2758);
s = Y.Array.reduce(this.get('columns'), s, function(s, column)
			{
				_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "(anonymous 30)", 2758);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2760);
...
container.set('innerHTML', s);
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2772);
this.table = container.get('firstChild');

			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2774);
this._attachEvents(this.table);
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2775);
Y.on('key', moveFocus, this.table, 'down:38,40+ctrl', this);

			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2777);
Y.Object.each(this.get('events'), function(e)
			{
				_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "(anonymous 31)", 2777);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2779);
...
while (this.table.get('children').size() > 1)
			{
				_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2787);
this.table.get('lastChild').remove().destroy(true);
	...
	_renderRecordContainer: function(
		...
		/* object */	record)
	{
		_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "_renderRecordContainer", 2792);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2796);
var body = Y.Node.create('<tbody></tbody>');
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2797);
...
body.set('className',
		...
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2802);
var msg_row = Y.Node.create('<tr></tr>');
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2803);
msg_row.set('className', BulkEditor.record_msg_container_class);

		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2805);
var msg_cell = Y.Node.create('<td></td>');
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2806);
...
msg_cell.set('innerHTML', BulkEditor.error_msg_markup);
		...
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2810);
msg_row.appendChild(msg_cell);
		_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2811);
...
return row;
	...
	_renderRecord: function(
		...
		/* object */	record)
	{
		_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "_renderRecord", 2820);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2824);
Y.Array.each(this.get('columns'), function(column)
		{
			_yuitest_coverfunc("/build/gallery-bulkedit/gallery-bulkedit.js", "(anonymous 32)", 2824);
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2826);
var key    = column.key;
...
var field  = this.getFieldConfig(key);
			...
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2831);
var cell = Y.Node.create('<td></td>');
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2832);
cell.set('className', cell_class + ' ' + cell_class_prefix + key);

			// create liner

			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2836);
...
liner.set('className', liner_class);
			...
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2841);
var f = null;
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2842);
if (Y.Lang.isFunction(column.formatter))
			{
				_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2844);
f = column.formatter;
			}
			else {_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2846);
...
if (field.type)
				...
				_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2856);
...
if (f)
			{
				_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2861);
f.call(this,
				{
					cell:   liner,
					key:    key,
			...
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2874);
cell.appendChild(liner);
			_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2875);
...
_yuitest_coverline("/build/gallery-bulkedit/gallery-bulkedit.js", 2881);
