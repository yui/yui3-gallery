YUI.add('gallery-md-inputfield', function(Y) {
...
}, '@VERSION@' ,{requires:['base-build', 'widget', 'widget-child', 'gallery-makenode', 'event-valuechange'], optional:['panel'], skinnable:true});
