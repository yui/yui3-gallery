...
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 92);
Y.FooterView = Y.Base.create( 'tableFooter', Y.View, [], {
      ...
      initializer: function(config) {
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "initializer", 206);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 207);
config || (config={});

          // Set a reference to the calling DataTable
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 210);
this._dt = ( config.source ) ? config.source :  config.host;    // reference to DT instance

          // Setup listeners ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 213);
this._subscr = [];
...
if ( config.footerConfig && config.footerConfig.fixed && this._dt.get('scrollable') ) {
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 217);
this._subscr.push( Y.Do.after( this._buildFixedFooter, this._dt, '_syncScrollUI', this._dt) );
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 221);
this._subscr.push( this._dt.data.after(['*:change','*:add','*:create', '*:remove', '*:reset'], Y.bind('refreshFooter', this) ) );
       ...
       */
      destructor: function () {
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "destructor", 232);
...
Y.Array.each(this._subscr,function(item){
              _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 2)", 233);
...
this._dt._tfootNode.empty();
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 237);
...
var foot_cont = this.get('container'),      // reference to the TFOOT, created by DataTable
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 263);
this.node_cols = [];

          //
          //  Initialize date and time formats
          //
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 268);
this.dateFormat = ( foot_cfg && foot_cfg.dateFormat ) ? foot_cfg.dateFormat
              : ( table_obj.get('dateFormat') ) ? table_obj.get('dateFormat')
              : this.dateFormat;

          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 272);
this.timeFormat = ( foot_cfg && foot_cfg.timeFormat ) ? foot_cfg.timeFormat
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 277);
var replacer_obj = {
...
Y.Object.each(replacer_obj,function(val,key,obj){
              _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 3)", 284);
...
obj[ key.toLowerCase() ] = val;
          ...
          //  Process the TH part
          //
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 291);
if ( foot_cfg.heading ) {
...
tfoot_th = this.fnReplace( this.TMPL_th, {
              ...
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 299);
var th_item = {
                  index:	 0,
                  key:		 0,
                  td:		 null,
...
this.node_cols.push(th_item);
          ...
          //
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 316);
...
td_html[imatch].formatter = fitem.formatter;}
                  ...
                  _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 357);
if ( fitem.className )
...
td_html[imatch].className = fitem.className;}
          ...
          //
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 366);
Y.Array.each( td_html, function(item){
              _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 6)", 366);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 367);
...
this.node_cols.push( item );
          ...
          //
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 381);
var trClass = this._dt.getClassName('footer');
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 382);
...
var tr = this.fnReplace( tr_tmpl, {
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 390);
...
// --------------------------------------------------------------------------------
      ...
      calcDatasetValue: function(colKey, calc) {
          ...
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "calcDatasetValue", 444);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 446);
var rs_data = this._dt.get("data"),    // this is a modelList currently
              rcalc   = 0;

          // If a string, then process it ....

          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 451);
...
if ( lcalc.search(/{col_count}/) !== -1  ) 	{return this._dt.get("columns").length;}
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 462);
...
rs_data.each( function(item) {
                  _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 7)", 474);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 475);
var colItem = item.get(colKey),
            ...
            */
                  ...
                  _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 485);
if ( lcalc.search(/{sum}/) !== -1 || avg !==-1 )
                      {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 486);
rcalc += rflt;}

                  else {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 488);
...
rcalc = Math.min( rcalc, rflt );}
                  ...
                  else {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 491);
if ( lcalc.search(/{max}/) !== -1 )
                      {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 492);
rcalc = Math.max( rcalc, rflt );}

                  else
                      {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 495);
rcalc = calc;}}}
              });
...
if ( avg !== -1 )
                  {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 502);
rcalc = ( !rs_data.isEmpty() ) ? ( parseFloat(rcalc)/parseFloat(rs_data.size()) ) : 0;}

              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 504);
return parseFloat(rcalc);   // processed later in formatFootCell to proper output format
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 509);
...
return calc;}
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 513);
...
var rtn = calc.call(this,rs_data);
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 515);
return rtn;
          }
      },
      ...
      formatFootCell: function( col, foot_col ) {
          ...
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "formatFootCell", 529);
...
rval = ( fmtr && fmtr.call ) ? fmtr.call( this, {value:rval, column:col} ) : rval;
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 547);
if ( Y.Lang.isFunction(foot_col.content) ) {
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 548);
return rval;
          } else {
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 550);
...
if ( ctag && Y.Lang.isString(ctag) )
                  {_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 553);
srtn = srtn.replace(ctag,rval);}
               _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 554);
return srtn;
      ...
      refreshFooter: function(){
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "refreshFooter", 568);
...
Y.Array.each( this.node_cols, function(fitem,findex) {
              _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 8)", 576);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 577);
var td_html;
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 578);
if ( fitem.th ) {
...
var replacer_obj = {
                  ...
                  _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 586);
Y.Object.each(replacer_obj,function(val,key,obj){
                      _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 9)", 586);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 587);
obj[ key.toLowerCase() ] = val;
                  });
...
td_html = this.fnReplace( fitem.th.content, replacer_obj );
              ...
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 594);
if ( !fitem.th && fitem.content ) {
                  _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 595);
td_html = this.formatFootCell( fitem, fitem.foot_cfg);
              }

              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 598);
...
return this;
      ...
      */
      ...
      resizeFooter : function() {
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "resizeFooter", 624);
...
var table_obj = this._dt,
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 630);
if( table_obj._yScroll ) {

              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 632);
function _getNumericStyle(node,style){
                  _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "_getNumericStyle", 632);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 633);
var style  = node.getComputedStyle(style),
                      nstyle = (style) ? +(style.replace(/px/,'')) : 0;
                  _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 635);
return nstyle;
              }

              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 638);
...
Y.Array.each( this.node_cols, function(col,i) {
                  _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "(anonymous 10)", 640);
...
if ( col.th ) {
                      _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 644);
for(var j=0; j<col.th.colspan; j++) {
                          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 645);
...
col_width += _getNumericStyle(thead_th,'width');
                      ...
                      _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 648);
col_width += col.th.colspan-1;  // subtract the 1px border between columns spanned
                  } else {
                      _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 650);
...
// --------------------------------------------------------------------------------
      ...
      _buildFixedFooter : function() {
          _yuitest_coverfunc("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", "_buildFixedFooter", 685);
_yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 686);
var fixedFooter   = this._yScrollFooter,    // Node for footer containing TABLE element
          ...
          _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 691);
if (!fixedFooter) {
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 692);
var tmpl = '<table cellspacing="0" aria-hidden="true" class="{className}"></table>';
              ...
              //
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 697);
fixedFooter =  Y.Node.create(
              ...
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 702);
...
var tfootNode = this.get('contentBox').one('table > tfoot');
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 711);
this._tfootNode = tfootNode;
              _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 712);
if ( tfootNode ) {
                  _yuitest_coverline("/build/gallery-datatable-footerview/gallery-datatable-footerview.js", 713);
