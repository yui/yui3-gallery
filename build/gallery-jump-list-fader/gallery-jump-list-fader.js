YUI.add('gallery-jump-list-fader', function(Y) {
	...
	JLF = function(config) {
		JLF.superclass.constructor.apply(this,arguments);
	};
	
	Y.extend(JLF, Y.Plugin.Base, {
		_anims : [],
	...
	Y.namespace('Plugin').JumpListFader = JLF;


}, 'gallery-2010.06.30-19-54' ,{requires:['node','anim','event','plugin']});
